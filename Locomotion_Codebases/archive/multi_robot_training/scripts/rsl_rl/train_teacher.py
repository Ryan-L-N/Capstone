...
def main():
    ...
    if robot == "spot":
        from quadruped_locomotion.tasks.locomotion.config.spot.env_cfg import SpotTeacherEnvCfg
        ...
        env_id = "Locomotion-Teacher-Spot-v0"
        EnvCfgClass = SpotTeacherEnvCfg
    else:
        from quadruped_locomotion.tasks.locomotion.config.vision60.env_cfg import Vision60TeacherEnvCfg
        ...
        env_id = "Locomotion-Teacher-Vision60-v0"
