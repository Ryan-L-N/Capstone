# Project Final Capstone Policy — Plain-Language Story

*A plain-English walkthrough of the Loco_Policy_5_Final_Capstone_Policy training arc: what we were trying
...
showed wrong observation shapes. Fix: rename to `configs/` and add an explicit
`__init__.py`.
