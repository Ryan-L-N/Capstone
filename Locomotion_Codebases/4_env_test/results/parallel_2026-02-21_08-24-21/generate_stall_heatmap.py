"""
Generates a standalone Stall Locations heatmap figure.
Output: report/flat_policy_plots/flat_stall_heatmap_standalone.png
"""
...
# Build stall heatmap: rows = environments, cols = zones 1-5
...
fig.tight_layout()
out = os.path.join(PLOTS_DIR, "flat_stall_heatmap_standalone.png")
