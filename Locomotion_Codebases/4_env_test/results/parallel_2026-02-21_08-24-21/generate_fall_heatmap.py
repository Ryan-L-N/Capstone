"""
Generates a standalone Fall Locations heatmap figure.
Output: report/flat_policy_plots/flat_fall_heatmap_standalone.png
"""
...
# Build fall heatmap: rows = environments, cols = zones 1-5
...
fig.tight_layout()
out = os.path.join(PLOTS_DIR, "flat_fall_heatmap_standalone.png")
