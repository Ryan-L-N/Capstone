"""
Fall Locations heatmap for Locomotion Policy 2 — stairs_approach v2.
...
ax.set_yticks([])
ax.set_title("Fall Locations — Loco Policy 2 Stairs Approach", fontsize=13, fontweight="bold")
