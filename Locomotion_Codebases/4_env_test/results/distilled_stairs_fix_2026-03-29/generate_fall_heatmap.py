"""
Generates a Fall Locations heatmap for Distilled policy stairs fix run.
...
recs = [json.loads(l) for l in open(os.path.join(BASE_DIR, "stairs_rough_episodes.jsonl"))]
...
ax.set_yticks([])
ax.set_title("Fall Locations — Distilled Stairs (Fix Applied)", fontsize=13, fontweight="bold")
