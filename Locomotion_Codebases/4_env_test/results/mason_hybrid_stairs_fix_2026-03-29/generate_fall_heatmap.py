"""
Generates a Fall Locations heatmap for Mason Hybrid stairs fix run.
...
ax.set_yticks([])
ax.set_title("Fall Locations — Mason Hybrid Stairs (Fix Applied)", fontsize=13, fontweight="bold")
