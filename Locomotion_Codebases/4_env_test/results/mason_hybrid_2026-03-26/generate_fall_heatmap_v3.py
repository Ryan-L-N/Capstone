...
Uses stairs_approach v3 data for the stairs column.
Output: report/mason_hybrid_fall_heatmap_v3.png
"""
...
STAIRS_DIR = os.path.join(
    ...
    "loco_policy2_stairs_approach_v3_2026-03-30"
)
...
fig.tight_layout()
out = os.path.join(PLOTS_DIR, "mason_hybrid_fall_heatmap_v3.png")
