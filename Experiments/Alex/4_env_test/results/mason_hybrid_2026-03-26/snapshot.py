"""
Quick-snapshot visualization for the mason_hybrid_best_33200 policy (2026-03-26).
...
fig.suptitle(
    "Mason Hybrid Policy — Trend Snapshot Across 4 Environments (100 episodes each)",
