"""
Generates a standalone Fall Locations heatmap for the Mason Hybrid policy.
Output: report/mason_hybrid_fall_heatmap.png
"""
...
fig.tight_layout()
out = os.path.join(PLOTS_DIR, "mason_hybrid_fall_heatmap.png")
