"""
Generates a standalone Fall Locations heatmap for the Distilled policy.
Output: report/distilled_fall_heatmap.png
"""
...
fig.tight_layout()
out = os.path.join(PLOTS_DIR, "distilled_fall_heatmap.png")
