"""
Fall Locations heatmap for Locomotion Policy 3 (Distilled).
Uses loco_policy3_stairs_approach_v2 data for the stairs column.
Output: report/distilled_fall_heatmap_approach.png
"""
...
STAIRS_DIR = os.path.join(
    ...
    "loco_policy3_stairs_approach_v2_2026-03-30"
)
...
fig.tight_layout()
out = os.path.join(PLOTS_DIR, "distilled_fall_heatmap_approach.png")
