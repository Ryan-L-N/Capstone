...
from quadruped_locomotion.tasks.navigation.modules.loco_wrapper import FrozenLocoPolicy
...
def load_nav_configs():
    ...
    from quadruped_locomotion.tasks.navigation.config.spot.env_cfg import SpotNavEnvCfg
    from quadruped_locomotion.tasks.navigation.config.spot.agents.rsl_rl_ppo_cfg import SpotNavPPORunnerCfg
    return SpotNavEnvCfg(), SpotNavPPORunnerCfg(), "Navigation-Mixed-Spot-v0"
