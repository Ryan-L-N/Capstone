...
def main():
    ...
    if robot == "spot":
        from quadruped_locomotion.tasks.locomotion.config.spot.env_cfg import SpotLocomotionEnvCfg_PLAY
        ...
        env_id = "Locomotion-Play-Spot-v0"
        EnvCfgClass = SpotLocomotionEnvCfg_PLAY
    else:
        ...
        env_id = "Locomotion-Play-Vision60-v0"
