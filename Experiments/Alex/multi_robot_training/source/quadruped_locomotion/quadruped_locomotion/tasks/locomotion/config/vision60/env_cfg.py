...
@configclass
class Vision60LocomotionEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    observations: Vision60ObservationsCfg = Vision60ObservationsCfg()
    actions: Vision60ActionsCfg = Vision60ActionsCfg()
    commands: Vision60CommandsCfg = Vision60CommandsCfg()
    rewards: Vision60RewardsCfg = Vision60RewardsCfg()
    terminations: Vision60TerminationsCfg = Vision60TerminationsCfg()
    events: Vision60EventCfg = Vision60EventCfg()
    curriculum: Vision60CurriculumCfg = Vision60CurriculumCfg()
...
# =============================================================================
# Teacher Environment — Privileged Observations (Phase 2a)
# =============================================================================

@configclass
class Vision60TeacherObservationsCfg(Vision60ObservationsCfg):
    """Teacher observations with privileged terrain information."""

    @configclass
    class PolicyCfg(Vision60ObservationsCfg.PolicyCfg):
...
@configclass
class Vision60TeacherEnvCfg(Vision60LocomotionEnvCfg):
