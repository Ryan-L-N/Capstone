...
def main():
    ...
    if robot == "spot":
        ...
        env_cfg = SpotPPOEnvCfg()
        EnvCfgClass = SpotPPOEnvCfg
        env_id = "Isaac-Velocity-Distill-Spot-v0"
    else:
        from configs.vision60_ppo_env_cfg import Vision60PPOEnvCfg
        env_cfg = Vision60PPOEnvCfg()
        EnvCfgClass = Vision60PPOEnvCfg
        env_id = "Isaac-Velocity-Distill-Vision60-v0"
    ...
    from configs.distill_ppo_cfg import DistillPPORunnerCfg
