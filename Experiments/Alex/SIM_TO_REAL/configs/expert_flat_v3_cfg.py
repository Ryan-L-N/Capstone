"""Flat Master V3 -- Adaptive reward system.
...
from .terrain_cfgs import FLAT_MASTER_TERRAINS_CFG
...
@configclass
class SpotFlatV3EnvCfg(SpotS2RBaseEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.terrain.terrain_generator = FLAT_MASTER_TERRAINS_CFG
        ...
        # Keep fixed penalties at base (flat terrain already well-tuned)
        # Standing envs
