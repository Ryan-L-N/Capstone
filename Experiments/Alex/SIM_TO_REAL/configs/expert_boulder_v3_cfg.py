"""Boulder Master V3 -- Adaptive reward system.
...
from .terrain_cfgs import BOULDER_MASTER_TERRAINS_CFG
...
@configclass
class SpotBoulderV3EnvCfg(SpotS2RBaseEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.terrain.terrain_generator = BOULDER_MASTER_TERRAINS_CFG
        ...
        # Loosen fixed penalties for obstacle navigation
